...
/*   Updated: 2025/01/07 04:29:59 by ssghioua         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * typedef struct s_redirection {
    ...
    // Cette liste chaînée doit être remplie par le parsing pour
	// indiquer toutes les redirections associées à la commande, par exemple
	// les fichiers et leurs types.
} t_redirection; 
*/
...
/*
 * typedef struct s_command {
    char *cmd_name;           // Nom de la commande principale
    ...
    // Cette structure doit être remplie par le parsing et contient
	// toutes les informations nécessaires pour exécuter une commande,
	// y compris les arguments, les redirections, et l'indicateur de built-in.
} t_command;
*/
 ...
 * typedef struct s_minishell {
	...
	//Cette structure globale est utilisée pour passer les variables
	//d'environnement et la liste des commandes à l'exécution.
}	t_minishell;
*/

// Prototypes des fonctions principales
bool		is_builtin_command(const char *cmd);
// Vérifie si la commande passée est un built-in
// (retourne true si oui, false sinon)

t_command	*create_command(char **args);
// Crée une structure t_command à partir des arguments fournis (args)
// et initialise les champs correspondants
...
// En cas d'erreur (commande non trouvée, redirection invalide),
// affiche un message d'erreur et met à jour le champ exit_status.

void		free_command(t_command *command);
// Libère la mémoire associée à une commande,
// y compris ses arguments et ses redirections

void		free_minishell(t_minishell *shell);
// Libère toute la mémoire associée à la structure t_minishell,
// y compris les commandes et l'environnement
